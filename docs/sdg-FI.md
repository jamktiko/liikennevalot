...
Kestävän kehityksen käytäntöjä pitäisi käyttää kaikkien sovulluksien kehityksessä. Kuuluu myös koulun yleisiin käytäntöihin.
...
Käytämme tekoälyä sovelluksen kehityksessä harkiten ja vain tarvittaessa.
...
Sovellus kerää vain käyttäjän syöttämän vapaavalintaisen nimen hahmolleen. Emme kerää tai säilytä mitään turhaa tietoa. Sovelluksen kehitysvaiheessa pyrimme käyttämään mahdollisimman vähän tekoälyä.
...
Sovelluksen käyttö ei edellytä mitään lisälaitteiden hankintaa ja itseasiassa suosii usean henkilön käyttävän samaa laitetta koska peli on paikallinen moninpeli.
...
Sovelluksessa käytetään ulkopuolista APIa, mutta se ei ole vaadittu sovelluksen toiminnan kannalta, ja on vaihdettavissa tarpeen tullessa. Sovellus ei siis ole riippuvainen sen toiminnasta.
...
Sovellus ei tee oletuksia käyttäjän ominaisuuksista, mutta se on suositeltu 18-vuotta täyttäneille, sillä peli on juomapeli. Asetuksen saa kuitenkin pois, joten ikäraja ei ole pakollinen. Peli noudattaa lain määräämiä saavutettavuusvaatimuksia. Peli on saatavilla vain Suomeksi, joten se ei ole saatavilla heille, jotka eivät puhu Suomea.
...
Sovellus edistää sosiaalista kanssakäyntiä, sillä peli vaatii vähintään kaksi pelaajaa. Pelillä on siis positiivisia vaikutuksia mielialaan ja sosiaalisiin suhteisiin.
...
Sovellusta voi mahdollisesti hyödyntää rikolliseen toimintaan, jos pelin pelaajat ovat alaikäisiä, ja he pelaavat peliä juomapelinä. Pelillä ei kuitenkaan ole laajia yhteiskunnallisia vaikutuksia. Peliin ei tarvitse syöttää mitään henkilökohtaisia tietoja muuta kuin vapaavalinnaisen nimen, eikä peli kerää tai tallenna mitään syötettyjä tietoja.
...
Kehittäjien hyvinvointi on huomioitu säännöllisillä jalottelutauoilla ja hyvällä ryhmähengellä. 
